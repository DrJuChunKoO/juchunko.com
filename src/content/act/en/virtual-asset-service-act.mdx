...
description: "A resource page on Legislator Ju-Chun Ko's work on Taiwan's Virtual Asset Service Act, including draft texts, Finance Committee review materials, attached resolutions, the deliberation video, and the policy timeline."
date: 2026-06-03
emoji: "🪙"
status: "Passed committee review in the Finance Committee on 2026/06/03; pending further plenary action"
---
...
<ActProgress
	...
	value={70}
	status="Committee review is complete; the bill still awaits plenary scheduling, consultation, or second and third reading procedures."
/>
