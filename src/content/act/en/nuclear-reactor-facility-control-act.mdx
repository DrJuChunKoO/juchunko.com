...
<Timeline>
	...
	<TimelineItem date="2025/03/07" title="Ko Ju-chun">
		Draft amendment to the Act, first reading passed, sent to committee.
	</TimelineItem>
	...
	<TimelineItem date="2025/03/19" title="Ko Ju-chun (Convener)">
		Public hearing on the Partial Amendments to the Nuclear Reactor Facilities Control Act.
	</TimelineItem>
	<TimelineItem date="2025/03/31" title="Ko Ju-chun (Convener)">
