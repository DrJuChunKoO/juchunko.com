...
description: "Autonomous driving technology can protect lives, but Taiwan's outdated vehicle rules are keeping people from using the latest transportation technology. A June 10 meeting confirmed that FSD Level 2 can be reviewed under Taiwan's existing mechanism without statutory amendment; on June 16, Tesla Taiwan formally submitted its FSD application documents to VSCC."
date: 2026-06-16
newsTopicIds: ["641c902e-1ce5-424e-beb8-51eb3c3c58ee"]
emoji: "🚗"
image: "/image/20260512-Brickphone.jpeg"
status: "Tesla Taiwan formally submitted FSD application documents to VSCC on June 16; technical review, road testing, and MOTC approval still follow"
---
...
<ActProgress
	...
	value={84}
	status="Tesla Taiwan has formally submitted FSD application documents to VSCC; technical review, MOTC approval, road testing, and technical committee deliberation still follow."
/>
...
3. For Tesla Taiwan's now-filed FSD application, proceed on the confirmed timeline of a VSCC technical committee within 2 to 4 weeks and MOTC approval within 2 weeks, so administrative process does not become a substantive barrier.
...
<Cards>
	...
	<CardGroup title="Taiwan FSD Review File">
		<Card
			slot="children"
			title="MOTC June 8 Written Reply"
			href="/file/autonomous-driving/motc-reply-1150608-autonomous-driving.pdf"
			target="_blank"
		>
			<FileText slot="icon" />
		...
		<Card slot="children" title="June 16 Tesla Taiwan FSD Filing" href="/en/act/autonomous-driving-deployment-initiative">
			<FileCheck slot="icon" />
			**Latest status**: Tesla Taiwan has submitted application documents to VSCC, moving the case into technical review, MOTC approval,
			road testing, and technical committee deliberation.
		</Card>
		<Card
			slot="children"
...
<NewsTopicEmbed topicId="641c902e-1ce5-424e-beb8-51eb3c3c58ee" lang="en" limit={3} heading="Related News" />

## Timeline

<Timeline>
	<TimelineItem date="2026.06.16" title="[Formal Filing] Tesla Taiwan submitted FSD application documents to VSCC">
