...
date: 2025-12-05
emoji: "🤖"
status: "Negotiation Completed, Awaiting Third Reading"
---
...
<Cards>
	<Card
		href="https://ipfs.juchunko.com/ipfs/bafkreihhrqmgdowtzksx3kwatooyxgm7gdxclpwbpn6rfolmhf5yw7ali4"
		target="_blank"
...
On December 4, 2025, Legislative Speaker Han Kuo-yu convened cross-party negotiations for the final discussion on the "AI Basic Law" draft. Except for the article on the "competent authority," which remains to be voted on in the plenary session, consensus was reached on all other provisions. The bill is now proceeding to the third reading.
