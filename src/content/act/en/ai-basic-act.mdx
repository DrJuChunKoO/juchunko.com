...
date: 2025-12-23
newsTopicIds: ["a6caf034-b235-4825-8dd8-ad1556b3441a"]
emoji: "🤖"
...
## Latest Act Downloads

<Cards>
	<CardGroup title="AI Basic Act Third-Reading Documents">
		<Card
			slot="children"
			title="Full Text (Bilingual PDF)"
			href="https://ipfs.juchunko.com/ipfs/bafybeigude52wj364ildy7c5omklbethenacmph7ktuhsylhkm7xpycywi/Taiwan_AI_Basic_Act_Bilingual_Final.pdf"
			target="_blank"
		>
			<Languages slot="icon" />
			**PDF**: Third reading final version in Chinese and English.
		</Card>
		<Card
			slot="children"
			title="Full Text (Bilingual DOCX)"
			href="https://ipfs.juchunko.com/ipfs/bafybeigude52wj364ildy7c5omklbethenacmph7ktuhsylhkm7xpycywi/Taiwan_AI_Basic_Act_Bilingual_Final.docx"
			target="_blank"
		>
			<Languages slot="icon" />
			**DOCX**: Third reading final version in Chinese and English.
		</Card>
		<Card
			slot="children"
			title="Articles & Explanations"
		...
		>
			<FileText slot="icon" />
			**Explanations**: MODA official Chinese version provided on 2025.12.24, including attached resolutions.
		</Card>
	</CardGroup>
</Cards>
...
## Timeline for Taiwan's Promotion and Legislative Debates on the AI Basic Act (2017–2025)
...
<Timeline>
    ...
    <TimelineItem date="2025.12.19" title="Plenary Vote Passed Article 2 of the Draft">
    	On 2025.12.19, the Legislative Yuan voted to pass Article 2 of the "AI Basic Act" draft regarding the competent authority, which was reserved during cross-party consultations convened by the Legislative Speaker. The KMT and TPP caucuses jointly proposed an amendment and a re-amendment motion, confirming the NSTC as the central competent authority and local governments as local competent authorities.
    	<div class="mt-4 space-y-2">
    		<Card
    ...
    <TimelineItem date="2025.12.04" title="Speaker Convenes Negotiation">
    	...
    	<YouTube id="heGA5WXGAhs" title="Cross-party negotiation before the AI Basic Act's third reading" />
    	<div class="mt-4">
    		<Card
    ...
    <TimelineItem date="March 2024" title="Legislator Ko Questioned">
    	Newly inaugurated Legislator Ju-Chun Ko immediately questioned the progress of the "AI Basic Act." Then-Premier Chen Chien-jen and Minister without Portfolio Wu Cheng-chung both responded positively, emphasizing "optimism, technological policy continuity, following the US and Japan models, and encouraging R&D."
    </TimelineItem>
...
**Expert List** (Names and titles preserved in original Chinese):
