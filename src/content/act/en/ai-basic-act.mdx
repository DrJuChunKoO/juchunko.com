...
import { Files, Scale, Video, MessageCircle, FileText, ShieldCheck, Gavel, Users } from "lucide-react";
import { YouTube } from "@astro-community/astro-embed-youtube";

# AI Basic Act

<div className="p-4 mb-6 bg-blue-50 border border-blue-200 rounded-lg dark:bg-blue-900/30 dark:border-blue-700">
  <div className="flex items-center gap-2 mb-4">
    <Scale className="w-5 h-5 text-blue-600 dark:text-blue-400" />
    <span className="font-bold text-lg text-blue-800 dark:text-blue-200">Download Third Reading Version</span>
  </div>
  <Cards>
    <Card
