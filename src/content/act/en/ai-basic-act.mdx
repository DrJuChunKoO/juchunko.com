...
On December 4, 2025, Legislative Speaker Han Kuo-yu convened a cross-party negotiation in the Legislative Yuan to conduct the final discussion on the "AI Basic Act" draft. With the exception of the article regarding the "Competent Authority," which is reserved for a plenary vote, consensus was reached on all other articles, and the bill is about to enter the third reading process.
