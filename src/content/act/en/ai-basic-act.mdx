...
<div className="p-6 mb-8 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-xl shadow-sm dark:bg-slate-800/60 dark:border-slate-700">
  <div className="flex items-center gap-3 mb-5 border-b border-blue-100 pb-3 dark:border-slate-700">
