...
<div className="not-prose my-6 rounded-lg border border-black/5 bg-gray-50 p-4 dark:border-white/10 dark:bg-white/5">
	<div className="mb-2 flex items-center justify-between gap-3 text-sm font-medium text-gray-900 dark:text-white">
		<span>Current progress</span>
		<span className="text-gray-500 dark:text-gray-400">55%</span>
	</div>
	<div className="mb-2 h-2 w-full rounded-full bg-gray-200 dark:bg-gray-700">
		<div className="h-2 rounded-full bg-gray-900 dark:bg-white" style={{ width: "55%" }}></div>
	</div>
	<p className="m-0 text-sm leading-6 text-gray-500 dark:text-gray-400">Libraries with AI has been approved by the Ministry of Education; AI vouchers are under Executive Yuan review within two months.</p>
</div>
