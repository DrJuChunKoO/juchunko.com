...
<div className="not-prose mb-8">
	<div className="mb-2 flex items-center gap-2 text-xl font-bold text-gray-900 dark:text-white">Paid AI should not belong only to those with resources</div>
    ...
    <p className="text-sm text-gray-500">Current progress: Libraries with AI approved by the Ministry of Education; AI vouchers under Executive Yuan review within two months (55%)</p>
