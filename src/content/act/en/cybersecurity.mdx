...
import { UserX, FileWarning, History } from "lucide-react";
import { YouTube } from "@astro-community/astro-embed-youtube";

# Cybersecurity Legislation and Issue Advocacy

<div className="not-prose mb-8">
	<div className="mb-2 flex items-center gap-2 text-xl font-bold text-gray-900 dark:text-white">Cybersecurity Reform: Building a Robust Shield for Digital Resilience</div>

    <div className="mb-2 h-4 w-full rounded-full bg-gray-200 dark:bg-gray-700">
    	<div className="h-4 rounded-full bg-gray-900 dark:bg-white" style={{ width: "45%" }}></div>
    </div>
    <p className="text-sm text-gray-500">Current Progress: Legislative deliberation and budget advocacy underway (45%)</p>
