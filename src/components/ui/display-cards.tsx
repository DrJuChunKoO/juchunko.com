...
function DisplayCard({
	...
	return (
		<m.div
			className={cn(
				"relative flex h-36 w-[min(26rem,75vw)] flex-col justify-between rounded-xl border bg-gradient-to-br px-6 py-4 drop-shadow-xs will-change-transform select-none",
