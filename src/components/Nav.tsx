...
export default function Nav({ lang }: NavProps) {
	...
	return (
		<div className="in-[.scrolled]:border-border bg-card/75 border-border/25 sticky inset-x-0 top-0 z-20 flex w-full flex-col border-b backdrop-blur-xl transition-colors print:hidden">
			<nav
				className={cn(
