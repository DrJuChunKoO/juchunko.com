		...
		<AnimatePresence>
			{isOpen && (
				<motion.div
					...
					style={{ bottom: y }}
					className="bg-card ring-border/50 fixed right-4 z-40 h-[180px] w-[360px] max-w-[calc(100vw-32px)] origin-bottom-right rounded-xl shadow-lg ring-1 backdrop-blur-xl"
				>
