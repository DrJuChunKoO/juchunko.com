...
The Legislative Yuan completed committee negotiations for the AI Basic Law on August 21, 2025, sending it to the plenary session for processing. The Executive Yuan subsequently passed the AI Basic Law draft on August 28, 2025, which will be submitted to the Legislative Yuan for review.
