...
<Cards>
  <Card
    href="https://ipfs.juchunko.com/ipfs/bafybeidgs366ixn7343yob6mwiqcioii35tg2hwhrxpyhqcbid2l7b4rgm"
    target="_blank"
...
## Update: The First Review is Coming.

The first review of the AI Basic Law will be held at a joint meeting of the Legislative Education and Culture Committee and the Transportation Committee. The review of proposals, including the "Artificial Intelligence Basic Law Draft" proposed by Legislator Ge Ru-jun and 37 others, will continue on June 11, 2025, at 9 a.m. Stay tuned.

## 0710 Supplement:

### 0704 – Remarks at the National Affairs Forum: an accompanying resolution will require the executive branch to complete a Child Impact Assessment within a set period after the AI Basic Act passes its third reading

AI has not just begun to develop in recent years. As early as 2018, then-Premier William Lai announced the “Taiwan AI Action Plan,” and during the 9th Legislative Yuan Legislator Jason Hsu proposed an AI Basic Act draft. If AI technology has been debated for nearly a decade, why has the government never conducted a Child Impact Assessment? All 113 lawmakers, regardless of party, care about children’s rights, but insisting on giving the administration even more time is irresponsible, enables bureaucratic inertia, and effectively undercuts the Legislature’s leadership. As long as the AI Basic Act remains unpassed, children’s rights remain unprotected.

Therefore, we have resolved to require the Ministry of Digital Affairs (MODA) to submit its own draft by **July 15**, and I will push for an attached resolution mandating that a Child Impact Assessment be completed within a specified period after the third reading.

Parliament Gazette (internal network only, PDF provided):

Page Yuan 50

[LCIDB01_11038801.pdf](attachment:07e37d73-9935-44ee-b9c2-bc62ba751350:LCIDB01_11038801.pdf)

### 0618 – Taiwan keeps chanting AI slogans while “waiting for the Executive Yuan”

From the “AI Cabinet” and “Sovereign AI” to the “AI Top Ten Projects,” policy details remain unseen, raising doubts about the government’s commitment.

The NDC-led “AI Top Ten Projects” claims it will drive NT$15 trillion in output and create 500,000 high-paying jobs, but when I asked for concrete data and implementation details, the minister said he had to “wait for Executive Yuan approval” before explaining. He could not even provide project contents, division of labor, or funding sources, clearly exposing insufficient preparation.

The same endless waiting occurs with the AI Basic Act, whose draft still languishes in the Executive Yuan. Astonishingly, the NDC minister even believed the draft had already reached the Legislature, demonstrating zero grasp of its progress. Even more absurdly, the NDC—responsible for AI development—did not participate in bill review meetings. How can it lead national AI policy?

Parliament Gazette: https://ppg.ly.gov.tw/ppg/SittingCommitteesInfo/download/communique1/final/pdf/114/60/LCIDC01_1146001_00014.pdf

### 0611 – Committee Review

While all parties agree that “AI is developing rapidly,” DPP legislators argue that, because it is advancing too fast, Taiwan should keep watching international attitudes; meanwhile, MODA has offered no comments on the existing drafts.

DPP lawmakers repeatedly claim that current drafts lack sufficient protection for women, diversity, persons with disabilities, indigenous peoples, remote areas, and other vulnerable groups. Yet Articles 4 (Protection of Freedom), 5 (Digital Inclusion), 6 (Fraud Prevention), and many subsequent provisions already contain overarching safeguards, consistent with the style of a basic act. Nevertheless, DPP members continue superficial discussion and substantive filibustering.

DPP legislators also said in the meeting that they “hope AI can develop more” and that “MODA should explain why, after many discussions, it still has not submitted the Executive Yuan draft,” yet MODA remains non-committal and has not produced its version, becoming the DPP’s excuse to block the review. The minister cites “observing international trends” as a reason to delay, ignoring that Taiwan does not yet have legislation and fundamentally differs from the mature legal frameworks in Europe and the United States. Countries such as the UK aim to avoid over-regulation, not halt legislation, and are already preparing comprehensive rules.

Countries like Korea, Japan, and the UK are actively rolling out AI legislation. If Taiwan continues to procrastinate, it will miss opportunities and expose the public to risks. After eight years of waiting, we must not accept further delays and empty talk.

Parliament Gazette: https://ppg.ly.gov.tw/ppg/SittingCommitteesInfo/download/communique1/final/pdf/114/58/LCIDC01_1145802_00003.pdf
...
- **May 14, 2025**
  **[Committee Interpellation]** The Executive Yuan’s Feb 26 decision shifted competent authority from NSTC to MODA with only a 54-character note; NSTC Minister Wu admitted prior ignorance, and MODA has yet to convene any consultations mandated by the draft.
  ...
  - Social post: [Facebook](https://www.facebook.com/share/p/1C6aX97iu4/)
  - Interpellation video: [YouTube](https://youtu.be/RQYlZ63IQ8c)
  - Bill intro video: [YouTube](https://youtu.be/yi4lvRO0Trw)
...
- **June 11, 2025**
  **[Committee Review Obstructed]** DPP legislators argued that “AI evolves too quickly,” nitpicked wording without offering amendments, and forced the meeting to adjourn. MODA promised to deliver its Executive Yuan draft to the Legislature by **July 15**.
  ...
  - Stream: [YouTube](https://www.youtube.com/live/6QaE1Skf4SU)
  - Ko’s post: [Facebook](https://www.facebook.com/share/p/19dtukMVzd/)

- **June 12, 2025**
  **[Livestream Debrief]** Legislator Ko livestreamed to expose the obstruction and called for swift passage.

  - Stream: [YouTube](https://youtube.com/live/21XP3XKPXZo?feature=share)
...
- **June 18, 2025**
  **[NDC Chair Liu Jing-qing Questioned]** The head of the “AI Top 10 Projects” initiative could not answer basic questions about the bill’s progress, highlighting the administration’s lack of coordination.
  ...
  - Interpellation video: [YouTube](https://youtu.be/zajFhCoZkCU)
  - Social post: [Facebook](https://www.facebook.com/share/p/16ow6FRtVj/)
  - Short clip: [Facebook](https://www.facebook.com/share/r/1BG8S1NMBu/)

- **July 4, 2025**
  **[National Affairs Forum]** Legislator Ko pressed the Executive Yuan to submit the AI Basic Act on schedule.

  - Social post: [Facebook](https://www.facebook.com/share/p/16wchMj3mR/)
  - Video: [YouTube](https://youtu.be/HXgJTc3ZSLU)

- **July 21, 2025**
  **[Second Article-by-Article Review Scheduled]** As committee chair, Ko has slated the Education & Culture Committee for the second line-by-line review of the AI Basic Act.
